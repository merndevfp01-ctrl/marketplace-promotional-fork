...
const Hero = forwardRef((props, ref) => {
  return (
    <div ref={ref} className="relative  w-full bg-[url('/hero-bg.png')] bg-cover bg-center bg-no-repeat">
      ...
      <div className="bg-black/40 ">
        <div className="container mx-auto w-full min-h-screen flex flex-col md:flex-row justify-center items-center px-4 md:px-0">
          {/* Left */}
          <div className="w-full md:w-1/2 px-4 md:px-0 space-y-6 md:space-y-8 text-center md:text-left">
            ...
            <div className="flex flex-col md:flex-row justify-center md:justify-start items-center gap-4 font-poppins">
              <Link
                href="/"
                className="bg-white flex items-center rounded-md gap-2 py-2 px-4 w-full md:w-60 justify-center"
              >
              ...
              <Link
                href="/"
                className="bg-white flex items-center rounded-md gap-2 py-2 px-4 w-full md:w-60  justify-center font-poppins"
              >
